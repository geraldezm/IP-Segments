...
<html>
    ...
    <form action="adddc.php" method="post">
    Data Center: <input type="text" name="dc" class="form-control input-sm">
    IP Range:<input type="text" name="iprange" class="form-control input-sm">
